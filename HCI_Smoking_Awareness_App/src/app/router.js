...
const LazyEChart = lazy(() => import("../views/charts/echartjs/echart"));
const Lazyuserchart = lazy(() => import("../views/charts/userchartjs/userchart"));
const LazyApexChart = lazy(() => import("../views/charts/apexchartjs/apexchart"))
const LazyAMChart = lazy(() => import("../views/pages/amchart"))
      ...
      return (
         ...
         <BrowserRouter basename="/">
            <Switch>
               ...
               <MainLayoutRoutes
                   exact
                   path="/charts/userchartjs"
                   render={matchprops => (
                      <Suspense fallback={<Spinner />}>
                         <Lazyuserchart {...matchprops} />
                       </Suspense>
                    )}
                />
                <MainLayoutRoutes
                    exact
                    path="/charts/apexchartjs"
                    render={matchprops => (
                       <Suspense fallback={<Spinner />}>
                          <LazyApexChart {...matchprops} />
                       </Suspense>
                     )}
                />
                <MainLayoutRoutes
                                    exact
                                    path="/pages/amchartjs"
                                    render={matchprops => (
                                       <Suspense fallback={<Spinner />}>
                                          <LazyAMChart {...matchprops} />
                                       </Suspense>
                                     )}
                                />
               {/* Maps Views */}
